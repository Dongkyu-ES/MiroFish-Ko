...
## � 
 ...
 Demo ��[mirofish-live-demo](https://666ghj.github.io/mirofish-demo/)
...
```env
# LLM API� OpenAI SDK  LLM API�
# qwen-plus�https://bailian.console.aliyun.com/
# �40
...
MiroFish/�Agent��**mirofish@shanda.com**

## � 

**MiroFish �**

MiroFish  **[OASIS](https://github.com/camel-ai/oasis)** � CAMEL-AI �
