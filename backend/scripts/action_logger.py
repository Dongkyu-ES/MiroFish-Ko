"""
동작 로그 기록기.
OASIS 시뮬레이션에서 각 Agent의 동작을 기록해 백엔드 모니터링에 사용한다.
...
class ActionLogger:
    """
    동작 로그 기록기 (이전 인터페이스 호환).
    가능하면 `SimulationLogManager` 사용을 권장한다.
    """
